...
مشروع `nile-key-v3` بدأ كنسخة قديمة من ERPNext/Frappe، لكنه موجه استراتيجياً لأن يتحول من مجرد نسخة ERPNext إلى **منصة وطنية رقمية لإدارة الصادرات**. المنصة المستهدفة ليست مجرد نظام داخلي، بل بوابة رقمية متكاملة تربط بين:
